...
\label{cha:ray-tracing-framework}
	...
	The reflection-map from ISM also have an optional iterative form. This is not a class like the \textbf{RayIterator} but just multiple reflection-maps in a list.
